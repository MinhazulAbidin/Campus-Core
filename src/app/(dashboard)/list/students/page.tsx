...
const StudentsListPage = () => {
  const renderRow = (item: Student) => (
    ...
    >
      ...
      <td className="hidden md:table-cell px-6 py-3">{item?.studentId}</td>
        ...
        <div className="flex items-center gap-2">
          {role === "admin" && (
            <>
              ...
              <FromModal table="student" type="delete" id={item?.id} />
            </>
          )}
        </div>
      </td>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex items-center gap-4 self-end ">
            ...
            {role === "admin" && <FromModal table="student" type="create" />}
          </div>
        </div>
      </div>
      {/* list  */}
      <div>
        <Table columns={columns} randerRow={renderRow} data={studentsData} />
      </div>
      {/* pagination  */}
      <div>
        <Pagination />
